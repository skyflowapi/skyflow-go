...
const (
	...
	DEIDENTIFY_FILE_REQUEST_FAILED                    = SDK_LOG_PREFIX + "Deidentify file request failed. Error: %v"
	INVALID_FILE_TYPE                                 = SDK_LOG_PREFIX + "Invalid %s request. Invalid file type. Specify a valid file type."
	GET_DETECT_RUN_REQUEST_FAILED                     = SDK_LOG_PREFIX + "Get detect run request failed. Error: %v"
	POLLING_FOR_RESULTS_FAILED                        = SDK_LOG_PREFIX + "Polling for results failed. Unable to retrieve the deidentified file"
	FAILED_TO_DECODE_PROCESSED_FILE                   = SDK_LOG_PREFIX + "Failed to decode processed file. Error: %v"
