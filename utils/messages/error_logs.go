...
const (
	...
	DETOKENIZE_DATA_REQUIRED                                 = SDK_LOG_PREFIX + "Invalid %s1 request. Detokenize data is required."
	...
	EMPTY_DETOKENIZE_DATA                                    = SDK_LOG_PREFIX + "Invalid %s1 request. Detokenize data can not be empty."
	...
	EMPTY_VAULT_ARRAY                                         = SDK_LOG_PREFIX + "Validation error. No vault configurations passed"
