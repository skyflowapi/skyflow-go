...
const (
	...
	EMPTY_DATA                                        string = SDK_PREFIX + " Validation error. 'data' can't be empty. Specify valid data."
	...
	EMPTY_KEY_IN_DATA								  string = SDK_PREFIX + " Validation error. Invalid key in data. Specify a valid key."
	EMPTY_DATA_IN_DATA_KEY                            string = SDK_PREFIX + " Validation error. Invalid data in data key. Specify a valid data."
